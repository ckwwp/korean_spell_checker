...
되다_EXCEPTIONS = {"얼마", "말", "기회", "부자", "배", "숙부", "여행", "형", "언니", "누나", "엄마", "아빠", "삼촌", "이모", "고모", "남편", "아내", "이튿날", "정도", "축제", "여정", "시간", "때", "돈", "습관", "파뿌리", "상태", "말동무", "후반부", "습관", "아미타불", "나중", "팬", "한참"}
...
_SPACING_ERRORS = [
    ...
    *rule()
    .AND(tag(Tag.관형사형전성어미), forms({"ㄹ", "는", "을"}))
    ...
    *rule()
    .AND(NOT(tag_form(Tag.연결어미, "지")), NOT(tag(Tag.일반부사)))
    .context()
    .AND(AND(NOT(tag_form(Tag.연결어미, "지")), NOT(tag_form(Tag.목적격조사, "ㄹ"))), NOT(tag(Tag.일반부사)))
    .context()
    .tag_form(Tag.일반부사, "못")
    .tag_form(Tag.동사, "하")
    .if_not_spaced()
    ...
    *rule()
    .tags({Tag.동사, Tag.형용사, Tag.형용사규칙활용, Tag.형용사불규칙활용})
    .tag_form(Tag.연결어미, "어")
    .tag_form(Tag.보조용언, "하")
    .if_spaced()
    ...
    *rule()
    ...
    .form("비")
    .if_spaced()
    .msg("'비용'의 뜻인 경우, '{form[0]}비'로 붙여 씁니다.")
    .build(),
    ...
    *rule()
    .tag_form(Tag.일반명사, "얼마")
    .context()
    .tag_form(Tag.일반부사, "안")
    .tag_form(Tag.동사, "되")
    .if_not_spaced()
    .msg("'안 되다'로 띄어 써야 합니다.")
    .build(),
    
    *rule()
    .AND(tags({Tag.연결어미}), forms({"어서", "으면"}))
    .context()
    .tag(Tag.보조사)
    .opt()
    .context()
...
_NNB = [
    *rule()
    .tag_form(Tag.관형사, "몇")
    .AND(tag(Tag.의존명사), forms({"번", "개", "명"}))
    .if_not_spaced()
    .msg("'몇 {form[1]}'batchim(\"으로\",\"로\") 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .AND(tag(Tag.의존명사), forms({"번", "개", "명"}))
    .if_not_spaced()
    .msg("'여러 {form[1]}'batchim(\"으로\",\"로\") 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .forms({"새", "덧"})
    .if_spaced()
    .msg("'{form[0]}{form[1]}'batchim(\"으로\",\"로\") 붙여 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .if_not_spaced()
    .msg("'{form[1]}'batchim(\"을\",\"를\") 앞 말과 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    .tags({Tag.관형사형전성어미, Tag.관형사, Tag.관형격조사})
    .AND(tag(Tag.의존명사), forms({"채", "만큼", "바", "적", "둥", "척", "리", "뻔", "터", "줄", "대로", "김", "등"}))
    .if_not_spaced()
    .msg("'{form[0]}'batchim(\"을\",\"를\") 앞 말과 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    .tag_form(Tag.관형사, "한")
    .AND(tag(Tag.의존명사), forms({"방", "푼", "닢", "아름"}))
    .if_not_spaced()
    .msg("'한 {form[0]}'batchim(\"으로\",\"로\") 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    .NOT(tag_form(Tag.형용사규칙활용, "그렇")) # 그럴듯하다를 한 단어로 못 잡아서 추가
    .context()
    .tags({Tag.관형사형전성어미, Tag.관형사, Tag.관형격조사})
    .tag_form(Tag.의존명사, "듯")
    .if_not_spaced()
    .NOT(tag_form(Tag.동사, "말"))
    .context()
    .NOT(tag_form(Tag.의존명사, "듯"))
    .context()
    .msg("'듯'을 앞 말과 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .tag_form(Tag.의존명사, "만")
    .if_not_spaced()
    .msg("'만'을 앞 말과 띄어 써야 합니다.")
    .build(),

    *rule()
    .AND(tag(Tag.관형사형전성어미), forms({"ㄹ", "을"}))
    .tag_form(Tag.의존명사, "만")
    .if_not_spaced()
    .tag_form(Tag.형용사파생접미사, "하")
    .if_spaced()
    .msg("'OO할 만하다'로 띄어 써야 합니다.")
    .build(),
]
...
_NNG = [
    ...
    *rule()
    ...
    .if_spaced()
    .msg("'별다른 {form[1]}'batchim(\"이라\",\"라\")는 의미의 '{form[0]}{form[1]}'batchim(\"은\",\"는\") 한 단어이므로 붙여 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .if_spaced()
    .msg("'첫{form[1]}'batchim(\"으로\",\"로\") 붙여 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .if_spaced()
    .msg("'한{form[1]}'batchim(\"으로\",\"로\") 붙여 써야 합니다.")
    .build(),
    
    *rule()
    .tag_form(Tag.관형사, "한")
    .AND(tag(Tag.일반명사), forms({"수", "몸"}))
    .if_not_spaced()
    .msg("'한 {form[1]}'batchim(\"으로\",\"로\") 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .if_not_spaced()
    .msg("'{form[0]} {form[1]}'batchim(\"으로\",\"로\") 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    .NOT(tags({Tag.관형사형전성어미, Tag.형용사파생접미사, Tag.관형격조사, Tag.목적격조사}))
    .context()
    .tag_form(Tag.일반명사, "옛날")
    .AND(tag(Tag.일반명사), forms({"얘기", "이야기"}))
    .if_spaced()
    .msg("'옛날{form[1]}'로 붙여 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .if_spaced()
    .msg("'단 음식'을 가리킬 때는 '단{form[2]}'batchim(\"으로\",\"로\") 붙여 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .AND(tag(Tag.의존명사), forms({"것", "거"}))
    .if_spaced()
    .msg("'아무{form[1]}'batchim(\"으로\",\"로\") 붙여 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .tag_form(Tag.일반명사, "처음")
    .if_spaced()
    .msg("'난생처음'으로 붙여 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .tag_form(Tag.어근, "면밀")
    .if_spaced()
    .msg("'주도면밀'로 붙여 써야 합니다.")
    .build(),
    
    *rule()
    .tag_form(Tag.대명사, "자기")
    .tag_form(Tag.일반명사, "희생")
    .if_spaced()
    .msg("'자기희생'으로 붙여 써야 합니다.")
    .build(),
    
    *rule()
    .tag_form(Tag.일반명사, "더미")
    .if_not_spaced()
    .msg("'더미'를 앞 말과 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .tag_form(Tag.일반명사, "발")
    .if_not_spaced()
    .msg("'자기의 발'의 의미인 경우, '제 발'로 띄어 써야 합니다.")
    .build(),
    
    *rule()
    .tag_form(Tag.관형사, "현")
    .tag_form(Tag.일반명사, "위치")
    .if_not_spaced()
    .msg("'현 위치'로 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .if_not_spaced()
    .msg("'앓는 소리'로 띄어 써야 합니다.")
    .build(),
    
    *rule()
    .tag_form(Tag.일반명사, "도로아미타불")
    .msg("'도로 아미타불'로 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .tag_form(Tag.관형사형전성어미, "ㄴ")
    .tag_form(Tag.의존명사, "척")
    .msg("'본척만척'으로 붙여 써야 합니다.") # '본척만척'은 명사로 등록되어 있으므로 이렇게 분해된다면 띄어 쓴 것.
    .build(),
    ...
    *rule()
    ...
    .tag_form(Tag.관형사형전성어미, "ㄴ")
    .tag_form(Tag.의존명사, "체")
    .msg("'본체만체'로 붙여 써야 합니다.") # '본체만체'는 명사로 등록되어 있으므로 이렇게 분해된다면 띄어 쓴 것.
    .build(),
    
    *rule()
    .tags({Tag.일반명사, Tag.고유명사})
    .tag_form(Tag.일반명사, "밀착")
    .if_not_spaced()
    .msg("'밀착'을 앞 말과 띄어 써야 합니다.")
    .build(),
...
_NNG_NNG = [
    ...
    *rule()
    ...
    .tag_form(Tag.일반명사, "행위")
    .if_spaced()
    .msg("'{form[0]}행위'로 붙여 써야 합니다.")
    .build(),

    *rule()
    .AND(tag(Tag.일반명사), forms({"여자", "남자"}))
    .AND(tag(Tag.일반명사), forms({"아이", "애"}))
    .if_spaced()
    .msg("'{form[0]}{form[1]}'batchim(\"으로\",\"로\") 붙여 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .AND(tag(Tag.일반명사), forms({"아저씨", "아주머니", "아줌마"}))
    .if_spaced()
    .msg("'주인{form[1]}'로 붙여 써야 합니다.")
    .build(),
...
_VV = [
    ...
    *rule()
    ...
    .tag_form(Tag.동사, "하")
    .if_spaced()
    .msg("'잘 못하다'로 붙여 써야 합니다.")
    .build(),
    
    *rule()
    .tag_form(Tag.연결어미, "ㄹ까")
    .tag_form(Tag.동사, "말")
    .tag_form(Tag.연결어미, "ㄹ까")
    .tag_form(Tag.동사, "하")
    .if_not_spaced()
    .msg("'~까 말까 하다'로 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    .tag_form(Tag.일반명사, "한눈")
    .tag_form(Tag.동사, "팔")
    .if_spaced()
    .msg("'한눈팔다'로 붙여 써야 합니다.")
    .build(),
...
_VX = [
    ...
    *rule()
    ...
    .tag_form(Tag.보조용언, "하")
    .if_not_spaced()
    .msg("'~어 하다'로 띄어 써야 합니다.")
    .build(),
    
    *rule()
    .tag(Tag.연결어미)
    .AND(tag(Tag.보조용언), forms({"않"}))
    .if_not_spaced()
    .msg("'{form[0]}다'를 앞 말과 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .tag_form(Tag.보조용언, "주")
    .if_not_spaced()
    .msg("'~지 말아 줘'와 같이, '주다'를 앞 말과 띄어 써야 합니다.")
    .build(),
    ...
    *rule()
    ...
    .tag_form(Tag.보조용언, "보")
    .if_not_spaced()
    .msg("'~나 보다'로 띄어 써야 합니다.")
    .build(),
    
    *rule()
    .AND(tag(Tag.연결어미), forms({"ㄴ가", "은가"}))
    .tag_form(Tag.보조용언, "보")
    .if_not_spaced()
    .msg("'~가 보다'로 띄어 써야 합니다.")
    .build(),
...
_VA = [
    ...
    *rule()
    .NOT(tags({Tag.관형사형전성어미, Tag.형용사파생접미사, Tag.관형격조사}))
    .context()
    .tag_form(Tag.일반명사, "꿈")
    .tag_form(Tag.형용사, "같")
    .if_spaced()
...
_MAG = [
    ...
    *rule()
    ...
    .if_spaced()
    .tag_form(Tag.연결어미, "나")
    .msg("'이러나저러나'로 붙여 써야 합니다.")
    .build(),
    
    *rule()
    .tag_form(Tag.일반부사, "곤드레")
    .tag_form(Tag.일반명사, "만드레")
    .if_spaced()
    .msg("'곤드레만드레'로 붙여 써야 합니다.")
    .build(),
...
_NEED_ML_JUDGE = [
    ...
    *rule()
    .form("자기")
    .tag_form(Tag.일반명사, "주장")
    .if_spaced()
    .msg("'자기주장'으로 붙여 써야 합니다.")
    .build(),
